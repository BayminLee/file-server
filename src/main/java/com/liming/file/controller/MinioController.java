package com.liming.file.controller;

import com.liming.file.dto.response.FileUploadResponse;
import com.liming.file.utils.MinioUtil;
...
public class MinioController {
    ...
    public FileUploadResponse upload(@RequestParam(name = "file", required = false) MultipartFile file,
                                     @RequestParam(required = false, defaultValue = "bucket1") String bucketName) {
    ...
    public void delete(@PathVariable("objectName") String objectName,
                       @RequestParam(required = false, defaultValue = "bucket1") String bucketName) throws Exception {
...
//            httpHeaders.add("Content-Type", "image/jpeg");
    ...
    public void preViewPicture(@PathVariable("objectName") String objectName,
                               HttpServletResponse response) throws Exception {
